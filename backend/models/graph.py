...
class Graph:
    ...
    def structure(
        self, supply: list[dict], demand: list[dict], transshipment: list[dict]
    ):
    ...
    def get_cii(self):
        ...
        for transition in self.transitions:
            if (
                transition.origin in self.get_conjunto_i()
                and transition.destination in self.get_conjunto_i()
            ):
    ...
    def get_cij(self):
        ...
        for transition in self.transitions:
            if (
                transition.origin in self.get_conjunto_i()
                and transition.destination in self.get_conjunto_j()
            ):
    ...
    def get_cik(self):
        ...
        for transition in self.transitions:
            if (
                transition.origin in self.get_conjunto_i()
                and transition.destination in self.get_conjunto_k()
            ):
    ...
    def get_cji(self):
        ...
        for transition in self.transitions:
            if (
                transition.origin in self.get_conjunto_j()
                and transition.destination in self.get_conjunto_i()
            ):
    ...
    def get_cki(self):
        ...
        for transition in self.transitions:
            if (
                transition.origin in self.get_conjunto_k()
                and transition.destination in self.get_conjunto_i()
            ):
